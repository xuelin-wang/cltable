...
cltable.cltableapp.table_data_body = (function cltable$cltableapp$table_data_body(p__20221){
var map__20224 = p__20221;
var map__20224__$1 = ((((!((map__20224 == null)))?((((map__20224.cljs$lang$protocol_mask$partition0$ & (64))) || (map__20224.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20224):map__20224);
var data = cljs.core.get.call(null,map__20224__$1,new cljs.core.Keyword(null,"data","data",-232669377));
return null;
});
cltable.cltableapp.table_overlay = (function cltable$cltableapp$table_overlay(p__20226){
var map__20229 = p__20226;
...
var data = cljs.core.get.call(null,map__20229__$1,new cljs.core.Keyword(null,"data","data",-232669377));
return null;
});
cltable.cltableapp.table_header = (function cltable$cltableapp$table_header(p__20231){
var map__20234 = p__20231;
...
var header = cljs.core.get.call(null,map__20234__$1,new cljs.core.Keyword(null,"header","header",119441134));
var columns_visibility = cljs.core.get.call(null,map__20234__$1,new cljs.core.Keyword(null,"columns-visibility","columns-visibility",1942278325));
var state = reagent.core.atom.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"active-header-index","active-header-index",21153652),(-1)], null));
var show_columns = ((function (state,map__20234,map__20234__$1,header,columns_visibility){
...
});})(state,map__20234,map__20234__$1,header,columns_visibility))
;
var default_cell_renderer = ((function (state,show_columns,map__20234,map__20234__$1,header,columns_visibility){
return (function (col,colindex,hidden){
return null;
});})(state,show_columns,map__20234,map__20234__$1,header,columns_visibility))
;
return null;
});
cltable.cltableapp.cltable = (function cltable$cltableapp$cltable(p__20236){
...
var preheaders = cljs.core.get.call(null,map__20239__$1,new cljs.core.Keyword(null,"preheaders","preheaders",-394352793));
var header = cljs.core.get.call(null,map__20239__$1,new cljs.core.Keyword(null,"header","header",119441134));
var header_cell_renderer = cljs.core.get.call(null,map__20239__$1,new cljs.core.Keyword(null,"header-cell-renderer","header-cell-renderer",-1111235556));
var get_data_cell_renderer = cljs.core.get.call(null,map__20239__$1,new cljs.core.Keyword(null,"get-data-cell-renderer","get-data-cell-renderer",1140304999));
var get_cell_spec = cljs.core.get.call(null,map__20239__$1,new cljs.core.Keyword(null,"get-cell-spec","get-cell-spec",-1510551370));
...
var select_cells = ((function (state,table_class_name,filter_criteria,map__20239,map__20239__$1,preheaders,header,header_cell_renderer,get_data_cell_renderer,get_cell_spec){
return (function (cells){
return null;
});})(state,table_class_name,filter_criteria,map__20239,map__20239__$1,preheaders,header,header_cell_renderer,get_data_cell_renderer,get_cell_spec))
;
var header_menu_col_index = null;
var show_filter_list = ((function (state,table_class_name,filter_criteria,select_cells,header_menu_col_index,map__20239,map__20239__$1,preheaders,header,header_cell_renderer,get_data_cell_renderer,get_cell_spec){
return (function (x,y,col_index){
return null;
});})(state,table_class_name,filter_criteria,select_cells,header_menu_col_index,map__20239,map__20239__$1,preheaders,header,header_cell_renderer,get_data_cell_renderer,get_cell_spec))
;
var columns_visibility = null;
var check_criteria = ((function (state,table_class_name,filter_criteria,select_cells,header_menu_col_index,show_filter_list,columns_visibility,map__20239,map__20239__$1,preheaders,header,header_cell_renderer,get_data_cell_renderer,get_cell_spec){
return (function (rowData){
return null;
});})(state,table_class_name,filter_criteria,select_cells,header_menu_col_index,show_filter_list,columns_visibility,map__20239,map__20239__$1,preheaders,header,header_cell_renderer,get_data_cell_renderer,get_cell_spec))
;
var set_cell_data = ((function (state,table_class_name,filter_criteria,select_cells,header_menu_col_index,show_filter_list,columns_visibility,check_criteria,map__20239,map__20239__$1,preheaders,header,header_cell_renderer,get_data_cell_renderer,get_cell_spec){
return (function (row_index,col_index,val){
return null;
});})(state,table_class_name,filter_criteria,select_cells,header_menu_col_index,show_filter_list,columns_visibility,check_criteria,map__20239,map__20239__$1,preheaders,header,header_cell_renderer,get_data_cell_renderer,get_cell_spec))
;
var table_data = null;
var tbodyClassName = null;
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-mouse-down","on-mouse-down",1147755470),((function (state,table_class_name,filter_criteria,select_cells,header_menu_col_index,show_filter_list,columns_visibility,check_criteria,set_cell_data,table_data,tbodyClassName,map__20239,map__20239__$1,preheaders,header,header_cell_renderer,get_data_cell_renderer,get_cell_spec){
return (function (){
return cltable.cltableapp.reset_overlay.call(null);
});})(state,table_class_name,filter_criteria,select_cells,header_menu_col_index,show_filter_list,columns_visibility,check_criteria,set_cell_data,table_data,tbodyClassName,map__20239,map__20239__$1,preheaders,header,header_cell_renderer,get_data_cell_renderer,get_cell_spec))
