...
return cljs.core.swap_BANG_.call(null,cltable.core.todos,cltable.core.mmap,cljs.core.map,(function (p1__19750_SHARP_){
return cljs.core.assoc_in.call(null,p1__19750_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1),new cljs.core.Keyword(null,"done","done",-889844188)], null),v);
}));
});
cltable.core.clear_done = (function cltable$core$clear_done(){
return cljs.core.swap_BANG_.call(null,cltable.core.todos,cltable.core.mmap,cljs.core.remove,(function (p1__19751_SHARP_){
return cljs.core.get_in.call(null,p1__19751_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1),new cljs.core.Keyword(null,"done","done",-889844188)], null));
}));
});
...
cltable.core.todo_input = (function cltable$core$todo_input(p__19754){
var map__19758 = p__19754;
var map__19758__$1 = ((((!((map__19758 == null)))?((((map__19758.cljs$lang$protocol_mask$partition0$ & (64))) || (map__19758.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19758):map__19758);
var title = cljs.core.get.call(null,map__19758__$1,new cljs.core.Keyword(null,"title","title",636505583));
var on_save = cljs.core.get.call(null,map__19758__$1,new cljs.core.Keyword(null,"on-save","on-save",1618176266));
var on_stop = cljs.core.get.call(null,map__19758__$1,new cljs.core.Keyword(null,"on-stop","on-stop",1520114515));
var val = reagent.core.atom.call(null,title);
var stop = ((function (val,map__19758,map__19758__$1,title,on_save,on_stop){
return (function (){
...
});})(val,map__19758,map__19758__$1,title,on_save,on_stop))
;
var save = ((function (val,stop,map__19758,map__19758__$1,title,on_save,on_stop){
return (function (){
...
});})(val,stop,map__19758,map__19758__$1,title,on_save,on_stop))
;
return ((function (val,stop,save,map__19758,map__19758__$1,title,on_save,on_stop){
return (function (props){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),cljs.core.merge.call(null,props,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,val),new cljs.core.Keyword(null,"on-blur","on-blur",814300747),save,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (val,stop,save,map__19758,map__19758__$1,title,on_save,on_stop){
return (function (p1__19752_SHARP_){
return cljs.core.reset_BANG_.call(null,val,p1__19752_SHARP_.target.value);
});})(val,stop,save,map__19758,map__19758__$1,title,on_save,on_stop))
,new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),((function (val,stop,save,map__19758,map__19758__$1,title,on_save,on_stop){
return (function (p1__19753_SHARP_){
var G__19760 = p1__19753_SHARP_.which;
switch (G__19760) {
case (13):
...
cltable.core.todo_edit = cljs.core.with_meta.call(null,cltable.core.todo_input,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),(function (p1__19762_SHARP_){
return reagent.core.dom_node.call(null,p1__19762_SHARP_).focus();
})], null));
cltable.core.todo_stats = (function cltable$core$todo_stats(p__19763){
var map__19767 = p__19763;
var map__19767__$1 = ((((!((map__19767 == null)))?((((map__19767.cljs$lang$protocol_mask$partition0$ & (64))) || (map__19767.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19767):map__19767);
var filt = cljs.core.get.call(null,map__19767__$1,new cljs.core.Keyword(null,"filt","filt",169229082));
var active = cljs.core.get.call(null,map__19767__$1,new cljs.core.Keyword(null,"active","active",1895962068));
var done = cljs.core.get.call(null,map__19767__$1,new cljs.core.Keyword(null,"done","done",-889844188));
var props_for = ((function (map__19767,map__19767__$1,filt,active,done){
return (function (name){
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.call(null,name,cljs.core.deref.call(null,filt)))?"selected":null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__19767,map__19767__$1,filt,active,done){
return (function (){
return cljs.core.reset_BANG_.call(null,filt,name);
});})(map__19767,map__19767__$1,filt,active,done))
], null);
});})(map__19767,map__19767__$1,filt,active,done))
;
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span#todo-count","span#todo-count",-1116128108),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"strong","strong",269529000),active], null)," ",(function (){var G__19769 = active;
switch (G__19769) {
case (1):
return "item";
...
var map__19776__$1 = ((((!((map__19776 == null)))?((((map__19776.cljs$lang$protocol_mask$partition0$ & (64))) || (map__19776.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19776):map__19776);
var id = cljs.core.get.call(null,map__19776__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var done = cljs.core.get.call(null,map__19776__$1,new cljs.core.Keyword(null,"done","done",-889844188));
var title = cljs.core.get.call(null,map__19776__$1,new cljs.core.Keyword(null,"title","title",636505583));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),[cljs.core.str((cljs.core.truth_(done)?"completed ":null)),cljs.core.str((cljs.core.truth_(cljs.core.deref.call(null,editing))?"editing":null))].join('')], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.view","div.view",-1680900976),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.toggle","input.toggle",-519545942),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"checkbox",new cljs.core.Keyword(null,"checked","checked",-50955819),done,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (map__19776,map__19776__$1,id,done,title,editing){
return (function (){
return cltable.core.toggle.call(null,id);
});})(map__19776,map__19776__$1,id,done,title,editing))
], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-double-click","on-double-click",1434856980),((function (map__19776,map__19776__$1,id,done,title,editing){
return (function (){
return cljs.core.reset_BANG_.call(null,editing,true);
});})(map__19776,map__19776__$1,id,done,title,editing))
], null),title], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button.destroy","button.destroy",1044866871),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__19776,map__19776__$1,id,done,title,editing){
return (function (){
return cltable.core.delete$.call(null,id);
});})(map__19776,map__19776__$1,id,done,title,editing))
], null)], null)], null),(cljs.core.truth_(cljs.core.deref.call(null,editing))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cltable.core.todo_edit,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),"edit",new cljs.core.Keyword(null,"title","title",636505583),title,new cljs.core.Keyword(null,"on-save","on-save",1618176266),((function (map__19776,map__19776__$1,id,done,title,editing){
return (function (p1__19771_SHARP_){
return cltable.core.save.call(null,id,p1__19771_SHARP_);
});})(map__19776,map__19776__$1,id,done,title,editing))
,new cljs.core.Keyword(null,"on-stop","on-stop",1520114515),((function (map__19776,map__19776__$1,id,done,title,editing){
return (function (){
...
return (function cltable$core$todo_app_$_iter__19783(s__19784){
return (new cljs.core.LazySeq(null,((function (items,done,active,filt){
return (function (){
var s__19784__$1 = s__19784;
while(true){
var temp__4425__auto__ = cljs.core.seq.call(null,s__19784__$1);
if(temp__4425__auto__){
var s__19784__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__19784__$2)){
var c__17278__auto__ = cljs.core.chunk_first.call(null,s__19784__$2);
var size__17279__auto__ = cljs.core.count.call(null,c__17278__auto__);
var b__19786 = cljs.core.chunk_buffer.call(null,size__17279__auto__);
if((function (){var i__19785 = (0);
while(true){
if((i__19785 < size__17279__auto__)){
var todo = cljs.core._nth.call(null,c__17278__auto__,i__19785);
cljs.core.chunk_append.call(null,b__19786,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cltable.core.todo_item,todo], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(todo)], null)));

var G__19788 = (i__19785 + (1));
i__19785 = G__19788;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__19786),cltable$core$todo_app_$_iter__19783.call(null,cljs.core.chunk_rest.call(null,s__19784__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__19786),null);
}
} else {
var todo = cljs.core.first.call(null,s__19784__$2);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cltable.core.todo_item,todo], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(todo)], null)),cltable$core$todo_app_$_iter__19783.call(null,cljs.core.rest.call(null,s__19784__$2)));
}
} else {
return null;
}
...
;
return iter__17280__auto__.call(null,cljs.core.filter.call(null,(function (){var G__19787 = (((cljs.core.deref.call(null,filt) instanceof cljs.core.Keyword))?cljs.core.deref.call(null,filt).fqn:null);
switch (G__19787) {
case "active":
